...
def linear_regression(df, features, export):
    ...
    print('LinearRegression average prediction error per hour: ', int(mae))
...
def get_average_error_among_all_clusters_with_random_forest_regression(df, sample_relation):
    ...
    mae_cluster_0 = random_forest_regression(cluster_0, ['Hour'], 4, False)
    mae_cluster_1 = random_forest_regression(cluster_1, ['Hour'], 4, False)
    mae_cluster_2 = random_forest_regression(cluster_2, ['Hour'], 4, False)
    mae_cluster_3 = random_forest_regression(cluster_3, ['Hour'], 4, False)
    mae_cluster_4 = random_forest_regression(cluster_4, ['Hour'], 4, False)
    mae_cluster_5 = random_forest_regression(cluster_5, ['Hour'], 4, False)
    mae_cluster_6 = random_forest_regression(cluster_6, ['Hour'], 4, False)
    mae_cluster_7 = random_forest_regression(cluster_7, ['Hour'], 4, False)
    mae_cluster_8 = random_forest_regression(cluster_8, ['Hour'], 4, False)
    mae_cluster_9 = random_forest_regression(cluster_9, ['Hour'], 4, False)
