...
def get_average_error_among_all_clusters_with_random_forest_regression(df, sample_relation):
    ...
    mae_cluster_2 = random_forest_regression(cluster_2, ['Hour'], 3, False)
    mae_cluster_3 = random_forest_regression(cluster_3, ['Hour'], 3, False)
    mae_cluster_4 = random_forest_regression(cluster_4, ['Hour'], 3, False)
    mae_cluster_5 = random_forest_regression(cluster_5, ['Hour'], 3, False)
    mae_cluster_6 = random_forest_regression(cluster_6, ['Hour'], 3, False)
