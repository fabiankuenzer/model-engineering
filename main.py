...
raw_data = load_data()
raw_data = raw_data.sample(10000)  # only for quick presentation purposes, remove for producing actual models
...
# plot_pickups_on_map(raw_data, 100000)
...
# Regression
cluster_0 = get_dataframes_with_amount_per_cluster(clustered_df, 0)
cluster_1 = get_dataframes_with_amount_per_cluster(clustered_df, 1)
cluster_2 = get_dataframes_with_amount_per_cluster(clustered_df, 2)
cluster_3 = get_dataframes_with_amount_per_cluster(clustered_df, 3)
cluster_4 = get_dataframes_with_amount_per_cluster(clustered_df, 4)
cluster_5 = get_dataframes_with_amount_per_cluster(clustered_df, 5)
cluster_6 = get_dataframes_with_amount_per_cluster(clustered_df, 6)
cluster_7 = get_dataframes_with_amount_per_cluster(clustered_df, 7)
cluster_8 = get_dataframes_with_amount_per_cluster(clustered_df, 8)
cluster_9 = get_dataframes_with_amount_per_cluster(clustered_df, 9)
...
# linear_regression(cluster_0, ['Lat', 'Lon', 'Weekend'])
# linear_regression(cluster_1, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_2, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_3, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_4, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_5, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_6, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_7, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_8, ['Lat', 'Lon', 'Hour'])
# linear_regression(cluster_9, ['Lat', 'Lon', 'Hour'])

# get_average_error_among_all_clusters_with_linear_regression(clustered_df, ['Lat', 'Lon', 'Hour'])
